...
class TrainOptions:
    def __init__(self):
        ...
        self.parser.add_argument(
            ...
            type=int,
            default=256,
            help="resized image size for training",
        )
        self.parser.add_argument(
        ...
        self.parser.add_argument(
            "--template", default=None, help="if template is included in training"
        )
        ...
        self.parser.add_argument(
            ...
            type=int,
            default=10,
            help="freq (epoch) of saving models",
        )
        self.parser.add_argument(
        ...
        self.parser.add_argument(
            "--lr_policy", type=str, default="step", help="type of learn rate decay"
        )  # MDMM used lambda
        self.parser.add_argument(
            "--n_ep", type=int, default=1200, help="number of epochs"
        )  # 400 * d_iter
        self.parser.add_argument(
            "--n_ep_decay",
            type=int,
...
class TestOptions:
    def __init__(self):
        ...
        self.parser.add_argument(
            ...
            type=int,
            default=1,
            help="translation direction, 1 for a2b, 0 for b2a",
        )
